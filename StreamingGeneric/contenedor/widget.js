...
export function initializeWidget() {
    ...
    const initialMessages = [
        'Hola, soy Tutor IA, tu tutor académico virtual. ¡Bienvenido a tu experiencia de aprendizaje! ¿Tienes dudas sobre el contenido, las actividades o la plataforma? Estoy para ti.',
        'Hola, soy Tutor IA, tu tutor académico virtual. ¿Listo para aprender? Puedo ayudarte con preguntas sobre tus cursos, evaluaciones o cómo avanzar más rápido.',
        'Hola, soy Tutor IA, tu tutor académico virtual. ¿Tienes preguntas sobre tu progreso, evaluaciones o próximas fechas clave? Pregúntame lo que quieras.'
    ];
